...
def job(pdb, smile):
    ...
    multiBranch_Conv_model.load_weights('/users/nirajv/scratch/PDiML/CHEMBL/re2/model_zoo/multiBranch_Conv_model_10-10000-ic50.h5')
    #multiBranch_Conv_model.load_weights('/users/nirajv/scratch/PDiML/CHEMBL/addHs/model_zoo/multiBranch_Conv_model_all.h5')
    #multiBranch_Conv_model.load_weights('/users/nirajv/scratch/PDiML/CHEMBL/re/SSnet_ECF/model_zoo/multiBranch_Conv_model_copy.h5')
    #multiBranch_Conv_model.load_weights('/users/nirajv/scratch/PDiML/DUDE/addHs/model_zoo/multiBranch_Conv_model_5t.h5')
    #multiBranch_Conv_model.load_weights('/users/nirajv/scratch/PDiML/DUDE/vina/addH/model_zoo/multiBranch_Conv_model_copy.h5')
    #multiBranch_Conv_model.load_weights('/users/nirajv/scratch/PDiML/DUDE/addHs/model_zoo/multiBranch_Conv_model_unbalanced.h5')
    #multiBranch_Conv_model.load_weights('/users/nirajv/scratch/PDiML/CHEMBL/addHs/model_zoo/multiBranch_Conv_model_copy.h5')
    ##multiBranch_Conv_model.load_weights('/users/nirajv/scratch/PDiML/CHEMBL/model_zoo/multiBranch_Conv_model.h5')
    ##multiBranch_Conv_model.load_weights('/users/nirajv/scratch/PDiML/DUDE/vina/model_zoo/multiBranch_Conv_model_copy.h5')
